...
<div align="center">
    <img src="assets/team/upc-logo.png" width="100px" height="auto"/>
    ...
    <p>
        ...
        Equipo
        <br><br>
        <strong>VanguardTech</strong>
        <br><br>
        Proyecto
        <br><br>
        <strong>(NOMRE DEL PROYECTO)</strong>
        <br><br>
        <strong>Integrantes</strong>
        <br><br>
        u202113612 - Araujo Ingunza, Renzo José 
        <br><br>
        u202111041 - Cordova Valdivia, Sebastián
        <br><br>
